...
import Cakc from './../assets/cake.png'
...
export default function Portfolio() {
  return (
    <section className='py-5 d-flex flex-column justify-content-center gap-3 align-items-center'>
          <h2 className={`${style.mainColor} text-uppercase fw-bolder fs-1`}>Portfolio</h2>
