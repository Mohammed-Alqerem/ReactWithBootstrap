...
export default function Hero() {
  return (
    <section className={`${style.heroBg} vh-100 d-flex  justify-content-center align-items-center`}>
         
          <div className="container">
              <div className='d-flex flex-column gap-3 justify-content-center align-items-center'>
                  <img src={photo} className='w-25' alt="avataars-photo" />
                  <h1 className='text-uppercase text-white  fw-medium '>Start Bootstrap</h1>
                  <div className='d-flex  justify-content-center gap-3  align-items-center'>
                      <div className={`${style.whiteLine}  w-50`}>
                  ...
                  <p className='fs-4 text-white '>Graphic Artist - Web Designer - Illustrator</p>
              </div>
          </div>
